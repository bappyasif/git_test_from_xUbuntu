class slideController {
  constructor(initialSlides, containterSelector, nextSelector, prevSelctor) {
    ...
    document.querySelector(prevSelctor).addEventListener("click", (e) => {
      let figure = e.target.parentNode.querySelector("figure");
      if (
        !figure.classList.contains("prev-anim") &&
        figure.classList.contains("next-anim")
      ) {
        figure.classList.remove("next-anim");
        // console.log("here");
        figure.classList.add("prev-anim");
        // figure.classList.remove("next-anim");
      }
    ...
    document.querySelector(nextSelector).addEventListener("click", (e) => {
      let figure = e.target.parentNode.querySelector("figure");
      if (
        !figure.classList.contains("next-anim", "slideImage") ||
        figure.classList.contains("prev-anim")
      ) {
        figure.classList.remove("prev-anim");
        // console.log("here");
        figure.classList.add("next-anim");
        // figure.classList.remove("next-anim");
      }
